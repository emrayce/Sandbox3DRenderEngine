...
std::vector<glm::mat4> PointLight::CalculateLightTransform()
{
	...
	// we create one for each face. Make sure the ordre match what we did in OmniShadowMap::Init()
	// +x / -x
	lightMatrices.push_back(lightProj * glm::lookAt(position, position + glm::vec3(1.0, 0.0, 0.0), glm::vec3(0.0, -1.0, 0.0))); // -1.0 due to the fact we reversing our lights
